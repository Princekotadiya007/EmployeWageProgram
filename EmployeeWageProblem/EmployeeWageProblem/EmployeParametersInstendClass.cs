...
{
    public class EmployeParametersInstendClass
    {
        ...
        public void ComputeEmpWage(string CompanyName, int EMP_RATE_PER_HRS, int NUM_OF_WORKING_DAYS, int MAX_RATE_IN_MONTH)
        {
